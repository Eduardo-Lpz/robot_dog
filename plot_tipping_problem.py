...
qual_level_lo = fuzz.interp_membership(x_qual, qual_lo, 3.1)
qual_level_md = fuzz.interp_membership(x_qual, qual_md, 3.1)
qual_level_hi = fuzz.interp_membership(x_qual, qual_hi, 3.1)
